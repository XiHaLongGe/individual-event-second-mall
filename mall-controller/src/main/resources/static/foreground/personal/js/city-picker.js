            ...
            this.$dropdown.find('.city-select')
                .each(function() {
                    var item = $(this).data('item'),
                        ...
                        pcdName = "";
                        if (type === "province"){
                            pcdName = "receivingInfProvince";
                        }else if(type === "city"){
                            pcdName = "receivingInfCity";
                        }else if(type === "district"){
                            pcdName = "receivingInfDistrict"
                        }else if(type === "county"){
                            pcdName = "receivingInfCounty"
                        }
                    if (item) {
                        text += ($(this).hasClass('province') ? '' : '/') + '<span class="select-item" name="' + pcdName + '" data-count="' +
