...
<head>
    ...
    <title>购物车</title>
    <link rel="stylesheet" href="/static/foreground/prount-cart/css/reset.css?v=<%= System.currentTimeMillis()%>">
    <link rel="stylesheet" href="/static/foreground/prount-cart/css/carts.css?v=<%= System.currentTimeMillis()%>">
...
<ul style="position: fixed; float:left">
    ...
    <h3><li><a  target="_blank" href="/mall/foreground/personal/home" style="text-decoration:none;"><p>个人中心</p></a></li></h3>
</ul>
...
<script src="/static/foreground/prount-cart/js/productCart.js?v=<%= System.currentTimeMillis()%>"></script>
<script src="/static/foreground/prount-cart/js/carts.js?v=<%= System.currentTimeMillis()%>"></script>
</body>
</html>
