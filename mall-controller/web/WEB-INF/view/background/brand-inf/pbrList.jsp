    ...
    <div class="layui-row">
        <form id="searchFORM" class="layui-form layui-col-md12 x-so">
            <div class="layui-input-inline">
                <select id="brandInfNameSELECT" name="modules" lay-search=""></select>
            </div>
            <div class="layui-input-inline">
                <select id="proCategorySELECT" name="modules" lay-search=""></select>
            </div>
...
<script src="/static/background/brand-inf/js/pbrBrandInf.js?v=<%= System.currentTimeMillis()%>"></script>
</body>
</html>
